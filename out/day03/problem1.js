            ...
            switch (_a.label) {
                case 0:
                    ...
                    rl.on('line', function (line) {
                        var sack = new RuckSack(line.trim());
                        var repeating_items = sack.repeating();
                        var priority = 0;
                        repeating_items.forEach(function (item) {
                            priority += item.priority;
                        });
                        total_priority += priority;
                        console.log("--- NEW SACK: ".concat(line.trim(), " ---"));
                        console.log("Repeating items: ".concat(JSON.stringify(Array.from(repeating_items))));
