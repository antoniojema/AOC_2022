...
var filepath = (0, path_1.resolve)(rootpath + "/src/day04/".concat(filename));
function main() {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    rl.on('line', function (line) {
                        console.log("--- NEW LINE: ".concat(line));
                        var range_pair = new ranges_1.SectorRangePair(line);
                        ...
                        console.log("Number of overlapped pairs: ".concat(n_overlapped));
                    });
